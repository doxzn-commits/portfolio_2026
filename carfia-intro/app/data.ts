...
export const SITE = {
  ...
  tel: "1833-4765",
  /** 화면과 JSON-LD 양쪽에 노출한다 */
  updatedAt: "2026-07-21",
  updatedLabel: "2026년 7월",
} as const;

/** 한 문장 정의 — h1 직후 첫 문단. AI 가 그대로 인용하게 될 문장 */
export const DEFINITION =
  "카피아(Carfia)는 매달 갱신되는 수입차 제조사·딜러 프로모션을 브랜드·모델별로 모아 비교하고, 할부·리스·장기렌트 조건까지 함께 확인해 실구매가를 알려주는 수입차 프로모션 비교 서비스입니다.";
...
export const PROOF_STATS = [
  { value: 10, suffix: "년", label: "자동차금융 업력", desc: "2011년 시작" },
  { value: 6800, suffix: "명+", label: "누적 고객", desc: "연간 기준" },
  { value: 1000, suffix: "억원+", label: "운용 규모", desc: "연간 기준" },
  { value: 24, suffix: "곳", label: "제휴 금융사", desc: "은행·캐피탈" },
];
...
export const FAQS: { q: string; a: string; link?: { label: string; href: string } }[] = [
  ...
  },
  {
    ...
    a: "원하시는 모델과 구매 방식을 남기시면 담당 매니저가 연락드려 조건을 확정합니다. 24개 제휴 금융사 조건을 함께 확인해 드립니다.",
  },
  {
    q: "어떤 브랜드를 취급하나요?",
